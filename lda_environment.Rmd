...
colnames(topic_probs) <- c("Nuclear", "Pollution", "Oil", "Wildlife")
rownames(topic_probs) <- rownames(res_topics)

##########################  The Independent ##########################

load("data/lda/indep_res.RData")
...
# Set column and row names
colnames(topic_probs_I) <- c("Earthquake", "Politics", "Mixed", "Mixed")
rownames(topic_probs_I) <- rownames(res_topics_I)

##########################  The Telegraph ##########################

load("data/lda/telegraph_res.RData")
...
# Set column and row names
colnames(topic_probs_T) <- c("Mixed", "Mixed", "Mixed", "Mixed")
rownames(topic_probs_T) <- rownames(res_topics_T)

##########################  The Daily Mail ##########################

load("data/lda/dailyEnvironment.RData")
...
# Set column and row names
colnames(topic_probs_D) <- c("Mixed", "Energy", "Mixed", "Mixed")
...
names(res_termsDF) <- c("Nuclear", "Pollution", "Oil", "Wildlife")
...
names(res_termsDF_I) <- c("Earthquake", "Politics", "Mixed", "Mixed")
...
names(res_termsDF_T) <- c("Mixed", "Mixed", "Mixed", "Mixed")
...
names(res_termsDF_D) <- c("Mixed", "Energy", "Mixed", "Mixed")
